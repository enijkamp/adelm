...
%% same as (13), but gradient fix for generator, langevin missing delta fix
...
config.real_ref = 1;
config.cap2 = 8;
config.infer_z = true;  % enabled inference

% prep
prefix = [img_name '/' num2str(img_size) '_15/'];
