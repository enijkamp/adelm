...
% prep
prefix = [img_name '/' num2str(img_size) '_5/'];
...
config.Delta2 = 0.3;
config.Gamma2 = [0.0005*ones(1,100), 0.0001*ones(1,100), 0.00005*ones(1,100), 0.00001*ones(1,100), 0.000005*ones(1,100)] / 2; % decreased 
config.refsig2 = 1;
config.s = 0.3;
config.real_ref = 1;
config.cap2 = 8;
