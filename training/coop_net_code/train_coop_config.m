function [config,net_cpu] = train_coop_config
    ...
    config.file_str = 'ivy2/128/';
    config.process_ims = 0; % 1 to create image patches from original im
    %config.process_str = 'ivy2/original/ivy.jpg'; %name of original image
    config.num_patch = 300;
    config.resize_factor = 2^(3);
